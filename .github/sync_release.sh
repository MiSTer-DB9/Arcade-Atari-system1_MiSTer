...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Atari-system1_MiSTer.git"
CORE_NAME=(Arcade-atarisys1)
...
UPSTREAM_CORE_NAME=(Arcade-atarisys1)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-atarisys1.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-atarisys1.rbf)
